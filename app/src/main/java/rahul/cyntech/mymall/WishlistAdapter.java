...
public class WishlistAdapter extends RecyclerView.Adapter<WishlistAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder viewHolder, @SuppressLint("RecyclerView") int position) {
        ...
        String cuttePrice = wishlistModelList.get(position).getCuttedPrice();
        boolean paymentMethod = wishlistModelList.get(position).isCOD();
        boolean inStock = wishlistModelList.get(position).isInStock();

        viewHolder.setDatad(productId,resource, title, freeCoupens, rating, totalRatings, productPrice, cuttePrice, paymentMethod , position, inStock);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        private void setDatad(String productId,String resource, String title, long freeCoupensNo, String averageRate, long totalRatingsNo, String price, String cuttedPriceValue, boolean COD, int index, boolean inStock) {
