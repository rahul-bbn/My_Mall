...
public class HomePageAdapter extends RecyclerView.Adapter {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int viewType) {
        ...
        switch (viewType) {
            ...
            case HomePageModel.STRIP_AD_BANNER:
                ...
                return new StripAddBannerViewHolder(stripAdView);
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder viewHolder, @SuppressLint("RecyclerView") int position) {
        switch (homePageModelList.get(position).getType()) {
            ...
            case HomePageModel.STRIP_AD_BANNER:
                ...
                ((StripAddBannerViewHolder) viewHolder).setStripAd(resource,color);
                break;
            ...
            case HomePageModel.GRID_PRODUCT_VIEW:
                String gridColorLayout = homePageModelList.get(position).getBackgroundColor();
                String gridLayoutTitle = homePageModelList.get(position).getTitle();
                List<HorizontalProductScrollModel>gridProductScrollModelList = homePageModelList.get(position).getHorizontalProductScrollModelList();
                ((GridProductViewholder)viewHolder).setGridProductLayout(gridProductScrollModelList,gridLayoutTitle,gridColorLayout);
                break;
            default:
                return;
        }
    ...
    public class StripAddBannerViewHolder extends RecyclerView.ViewHolder {
        ...
        private void setStripAd(String resource, String color) {
            Glide.with(itemView.getContext()).load(resource).apply(new RequestOptions().placeholder(R.mipmap.image_placeholder)).into(stripAdImage);
    ...
    public class GridProductViewholder extends RecyclerView.ViewHolder {
        ...
        private void setGridData(String title,List<HorizontalProductScrollModel> horizontalProductScrollModelList){
            for (int x = 0;x < 4;x++){
                ...
                Glide.with(itemView.getContext()).load(horizontalProductScrollModelList.get(x).getProductImage()).apply(new RequestOptions().placeholder(R.mipmap.image_placeholder)).into(productImage);
