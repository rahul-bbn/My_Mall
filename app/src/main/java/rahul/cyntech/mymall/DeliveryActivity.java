...
public class DeliveryActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        continueBtn = findViewById(R.id.cart_continue);
    ...
    private void showConfirmationLayout(){
        ...
        StringRequest stringRequest=new StringRequest(Request.Method.POST, SMS_API, new Response.Listener<String>() {
            ...
            public Map<String, String> getHeaders() throws AuthFailureError {
                ...
                headers.put("authorization","tyHTFZip7fLMluR305Vd9c4AgUBDPabCjXqIQKsE6kYnxzwWrJ5FpEPXju2RyDL40I6OhnaxJtMd8HTg");
    ...
    private void placeOrderDetails(){
        ...
        for (CartItemModel cartItemModel : cartItemModelList) {
            if (cartItemModel.getType() == CartItemModel.CART_ITEM) {
                ...
                orderDetails.put("Free Coupens",cartItemModel.getFreeCoupen());
    ...
    private void paytm(){
        ...
        final String M_id = "Y1utwW848099626406";
